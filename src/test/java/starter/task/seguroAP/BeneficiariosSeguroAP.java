...
public class BeneficiariosSeguroAP implements Task {
    ...
    public BeneficiariosSeguroAP(String tomarSeguroAP, String nombresSeguroAP, String parentescoSeguroAP) {
        this.tomarSeguroAP = tomarSeguroAP;
        this.nombresSeguroAP = nombresSeguroAP;
        this.parentescoSeguroAP = parentescoSeguroAP;
    }

    public static Performable whithBeneficiariosSeguroAP(String tomarSeguroAP, String nombresSeguroAP, String parentescoSeguroAP) {
        return instrumented(BeneficiariosSeguroAP.class,tomarSeguroAP, nombresSeguroAP, parentescoSeguroAP);
    }

    @Override
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(
                Check.whether(tomarSeguroAP.equals("Si"))
                        .andIfSo(
