...
public class referenciasForm {
    ...
    public static final Target listaRelacionRef = Target.the("lista para seleccionar valores del select relacion de la ref").locatedBy("//input[@id='{0}Relacion']/preceding-sibling::div");
