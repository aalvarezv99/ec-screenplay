...
public class ResultadoForm {
    ...
    public static final Target montoMaximoSugerido = Target.the("Valor del monto maximo sugerido ").locatedBy("//h6[text()='Monto máximo sugerido']/following-sibling::h6");
    ...
    public static final Target estudioCreditoIVA = Target.the("Valor del estudio de Credito ").locatedBy("//span[text()='Estudios crédito + IVA']/following-sibling::span");
    public static final Target valoresInteresesIniciales = Target.the("Valor de intereses iniciales ").locatedBy("//span[text()='Valor interéses iniciales']/following-sibling::span");
